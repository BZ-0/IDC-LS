...
{#if $iconItemId}
    ...
    <div class="icon-edit">
        ...
        <div class="buttons">
            <button type="button" class="edit-delete" data-action="delete-icon">Delete</button>
            <button type="button" class="edit-confirm" data-action="confirm-edit">Confirm</button>
        </div>
