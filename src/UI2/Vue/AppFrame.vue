<script setup>
    ...
    //
    const props = defineProps({ hashIdName: String });

    //
    let hashIdName = props.hashIdName || "#app";
...
<!-- -->
<template>
    <div :data-hidden="chash.value == hashIdName" data-scheme="solid" class="ux-frame ux-app-frame ux-default-theme ux-detached" v-bind="$attrs">
