...
<template>
    ...
    <div class="ui-shape-selector">
        <div class="ui-shape-frame" data-scheme="solid" data-highlight="1" data-highlight-hover="2" @click="vib">
